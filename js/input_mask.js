let input_header = document.getElementById('input4');
const phoneMask4 = new IMask(input_header, {
    mask: "+{7}(000)000-00-00",
  });
let input_second2 = document.getElementById('input_second2')
...
const phoneMask = new IMask(input_second, {
  mask: "+{7}(000)000-00-00",
});
